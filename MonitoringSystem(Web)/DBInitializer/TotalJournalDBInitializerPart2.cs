...
namespace MonitoringSystem_Web_.DBInitializer
{
    ...
    {
        protected void ClassInit(ref TotalJournalContextWeb context)
        {
            //номер группы           номер курса
            context.Classes.Add(new Class() { ClassID = "1"  });
            context.Classes.Add(new Class() { ClassID = "2"  });
            context.Classes.Add(new Class() { ClassID = "3"  });
            context.Classes.Add(new Class() { ClassID = "4"  });
            context.Classes.Add(new Class() { ClassID = "5"  });
            context.Classes.Add(new Class() { ClassID = "6"  });
            context.Classes.Add(new Class() { ClassID = "7"  });
            context.Classes.Add(new Class() { ClassID = "8"  });
            context.Classes.Add(new Class() { ClassID = "9"  });
            context.Classes.Add(new Class() { ClassID = "10" });
            context.Classes.Add(new Class() { ClassID = "11" });
        }

        protected void TeacherInit(ref TotalJournalContextWeb context)
        {
            ////                                  TeachersID++    
            context.Teachers.Add(new Teacher() { TeacherID = 1, FirstName = "Павел", MiddleName = "Александрович", LastName = "Лучшев" });
            context.Teachers.Add(new Teacher() { TeacherID = 2, FirstName = "Мария", MiddleName = "Александровна", LastName = "Данова"});
            context.Teachers.Add(new Teacher() { TeacherID = 3, FirstName = "Оксана", MiddleName = "Вадимовна", LastName = "Лучшева"});
            context.Teachers.Add(new Teacher() { TeacherID = 4, FirstName = "Юрий", MiddleName = "Семенович", LastName = "Манжос"});
            context.Teachers.Add(new Teacher() { TeacherID = 5, FirstName = "Людмила", MiddleName = "Васильевна", LastName = "Мандрикова"});
            context.Teachers.Add(new Teacher() { TeacherID = 6, FirstName = "Николай", MiddleName = "Григорьевич", LastName = "Мокляк"});
            context.Teachers.Add(new Teacher() { TeacherID = 7, FirstName = "Вероника", MiddleName = "Альбертовна", LastName = "Постернакова"});
            context.Teachers.Add(new Teacher() { TeacherID = 8, FirstName = "Лариса", MiddleName = "Федоровна", LastName = "Пудовкина"});
            context.Teachers.Add(new Teacher() { TeacherID = 9, FirstName = "Александр", MiddleName = "Александрович", LastName = "Резуненко"});
            context.Teachers.Add(new Teacher() { TeacherID = 10, FirstName = "Сергей", MiddleName = "Владимирович", LastName = "Россоха"});
            context.Teachers.Add(new Teacher() { TeacherID = 11, FirstName = "Евгения", MiddleName = "Витальевна", LastName = "Соколова"});
            context.Teachers.Add(new Teacher() { TeacherID = 12, FirstName = "Илона", MiddleName = "Владимировна", LastName = "Шевченко"});
            context.Teachers.Add(new Teacher() { TeacherID = 13, FirstName = "Юлия", MiddleName = "Анатольевна", LastName = "Кузнецова"});
            context.Teachers.Add(new Teacher() { TeacherID = 14, FirstName = "Елена", MiddleName = "Георгиевна", LastName = "Кириленко"});
            context.Teachers.Add(new Teacher() { TeacherID = 15, FirstName = "Владислав", MiddleName = "Анатольевич", LastName = "Демьяненко"});
            context.Teachers.Add(new Teacher() { TeacherID = 16, FirstName = "Татьяна", MiddleName = "Григорьевна", LastName = "Дегтярева"});
            context.Teachers.Add(new Teacher() { TeacherID = 17, FirstName = "Надежда", MiddleName = "Григорьевна", LastName = "Голубь"});
            context.Teachers.Add(new Teacher() { TeacherID = 18, FirstName = "Олег", MiddleName = "Николаевич", LastName = "Волошин"});
            context.Teachers.Add(new Teacher() { TeacherID = 19, FirstName = "Лина", MiddleName = "Алексеевна", LastName = "Волобуева"});
            context.Teachers.Add(new Teacher() { TeacherID = 20, FirstName = "Игорь", MiddleName = "Владимирович", LastName = "Шостак"});
            context.Teachers.Add(new Teacher() { TeacherID = 21, FirstName = "Игорь", MiddleName = "Борисович", LastName = "Туркин"});
            context.Teachers.Add(new Teacher() { TeacherID = 22, FirstName = "Борис", MiddleName = "Михайлович", LastName = "Конорев"});
        }
